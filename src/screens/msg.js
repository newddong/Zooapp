...
export const REQ_PHONE_NUM = '휴대폰 번호를 입력해주세요.(\'-\'제외)';
...
export const REQ_EMAIL = '이메일을 입력해주세요.';
...
export const REQ_CODE = '코드를 입력해 주세요';
export const ASK_SHELTER_ASSIGN = '보호소 등록을 하고싶으신가요?';
...
export const REQ_SHELTER_NAME = '보호소 이름을 입력하세요';
