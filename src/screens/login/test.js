...
export default Test = () => {
    ...
    return (
        <View style={{flex:1,backgroundColor:'yellow'}}
         ...
         onStartShouldSetResponderCapture={()=>{console.log('onStartShouldSetResponderCapture'+'최상위'); return false;}}
        ...
        >
            ...
            <View style={{top:300,width:200,height:200,backgroundColor:'gray',position:'relative'}}
            ...
            <View style={{top:30,width:200,height:200,backgroundColor:'green',position:'absolute'}}
                onStartShouldSetResponder={()=>{console.log('onstart'+'자식'); return false;}}
                onStartShouldSetResponderCapture={()=>{console.log('onStartShouldSetResponderCapture'+'자식'); return false;}}
            ...
            >
                ...
                <View style={{top:30,width:100,height:300,backgroundColor:'red',position:'absolute'}}
                onStartShouldSetResponder={()=>{console.log('onstart'+'손자'); return false;}}
                onStartShouldSetResponderCapture={()=>{console.log('onStartShouldSetResponderCapture'+'손자'); return true;}}
                onResponderGrant={(e)=>{console.log('onResponderGrant'+'손자');}}
