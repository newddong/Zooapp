		...
		<View style={profile.wrp_main}>
			...
			<View style={profile.cntr_details}>
					<View style={profile.title_details}>
						<View style={profile.icon_detail}><LikeIcon {...svg_size}/></View>
			...
			<View style={profile.cntr_details}>
					<View style={profile.title_details}>
						<View style={profile.icon_detail}><PawIcon {...svg_size} fill='#FFB6A5'/></View>
			...
			<View style={profile.cntr_details}>
					<View style={profile.title_details}>
						<View style={profile.icon_detail}><SettingIcon {...svg_size} fill='#FFB6A5'/></View>
